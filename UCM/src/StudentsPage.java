...
public class StudentsPage {
    ...
    private Object[][] fetchCourseData() {
        try {
            ...
            String query = "select stdid,stdname,stdemail,age from student";
    ...
    public StudentsPage() {
        ...
        //table
        String[] columnNames = {"Student ID","Name","Email","Age",};
        ...
        addButton.addActionListener(e -> {
            if (addButton.getText().equals("Add Student")) {
                AddStudent addPage = new AddStudent("Add Student","Add Student","Add Student","Student Added","Back","student","stdname","stdemail","password","dob","age");
                frame.dispose();
            }
        });
